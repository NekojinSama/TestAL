...
int main() {
	...
	{
		drwav_int16* pSampleData = drwav_open_file_and_read_pcm_frames_s16("sounds/lol.wav", &monoData.channels, &monoData.sampleRate, &monoData.totalPCMFrameCount, nullptr);
		if (pSampleData == NULL) {
	...
	// create a sound source for our stereo sound
	ALuint stereoSource;
